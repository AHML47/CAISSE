...
import models.classes.sel3as.PVC;

public class EPVC implements IEntity<PVC> {
    @Override
    ...
    @Override
    public Object getValueColumn(PVC object, String nameColumn) {
        switch (nameColumn) {
            case "id":
                return object.getId();
            case "name":
    ...
    @Override
    public void setValueColumn(PVC object, String nameColumn, Object value) {
        switch (nameColumn) {
            case "id":
