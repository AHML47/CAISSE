...
import models.classes.sel3as.ja3ba;

public class Eja3ba implements IEntity<ja3ba> {
    @Override
    ...
    @Override
    public Object getValueColumn(ja3ba object, String nameColumn) {
        switch (nameColumn) {
            case "id":
                return object.getId();
            case "name":
    ...
    @Override
    public void setValueColumn(ja3ba object, String nameColumn, Object value) {
        switch (nameColumn) {
            case "id":
