...
public class Esel3a implements IEntity<sel3a> {
    @Override
    ...
    @Override
    public Object getValueColumn(sel3a object, String nameColumn) {
        switch (nameColumn) {
            case "id":
                return object.getId();
            case "name":
    ...
    @Override
    public void setValueColumn(sel3a object, String nameColumn, Object value) {
        switch (nameColumn) {
            case "id":
